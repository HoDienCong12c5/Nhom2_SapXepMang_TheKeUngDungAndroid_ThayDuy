...
public class FlashSort implements Sort {
    ...
    public void Sort(int[] arr, int n, String kq) {
        ...
        int giaTriCT = 0;
        //  int giaTriCT = 0;
        FlashS(arr,0,n-1, Chitiet, giaTriCT);
    }
    ...
    public void FlashS(int[] arr, int left, int right, String[] Chitiet, int giaTriCT)
    {
        int i, j, giaTri;
        ...
        if (left<j)
        {
            FlashS(arr,left,j,Chitiet, giaTriCT);
        }
        if (i<right)
        {
            FlashS(arr,i,right,Chitiet, giaTriCT);
        }
    }
}
